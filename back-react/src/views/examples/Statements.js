            ...
            >
              <Card>
                ...
                <div style={{ marginBottom: "20px" }}>
                  <h4 className="font-weight-bold" style={{ color: "#666", marginBottom: "10px" }}>Accident Information</h4>
                ...
                <div>
                  <div style={{ marginBottom: "20px" }}>
                    <h4 className="font-weight-bold" style={{ color: "#666", marginBottom: "10px" }}>Driver's Identity</h4>
                  ...
                  <div>
                    <h6 className="font-weight-bold">Driver B:</h6>
                ...
                <hr />
                <div>
                  <h4 className="font-weight-bold">Insured Information</h4>
                  <div>
                    <h6>Insured A:</h6>
                  ...
                  <div>
                    <h6 className="font-weight-bold">Insured B:</h6>
                ...
                <hr />
                <div>
                  <h4 className="font-weight-bold">Vehicle Information</h4>
                  <div>
                    <h6 className="font-weight-bold">Vehicle A:</h6>
                  ...
                  <div>
                    <h6 className="font-weight-bold">Vehicle B:</h6>
                  ...
                  <div>
                    <h6 className="font-weight-bold">Vehicle Owner A:</h6>
                  ...
                  <div>
                    <h6 className="font-weight-bold">Vehicle Owner B:</h6>
